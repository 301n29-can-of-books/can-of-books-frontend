...
class About extends React.Component {
  ...
  render() {
    ...
    return (<section>
      ...
      <div className="bio2">
        <h3>Matt Austin</h3>
        <img className="img1" src="./img/matt-austin.jpg" alt="Matt image"/>
      ...
      <div className="bio2">
        <h3>Danner Taylor</h3>
        <img className="img1" src="./img/dannertaylor.jpg" alt="Danner image"/>
      ...
      <div className="bio2">
        <h3>Brenden Moore</h3>
        <img className="img1" src="./img/IMG_2844.jpg" alt="Brenden image"/>
